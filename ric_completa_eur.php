...
body {
  ...
  background-image: url(images/sfondoeur.jpg);
...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="hit-the-floor">Visualizzazione accessi - EUR</div></h3><BR>
                ...
                <TR style="font-family:Georgia, Garamond, Serif;font-size:small;">
                        ...
                        <TD><select name="ingresso" id="ingresso" style="color:black" value="<?php echo isset($_POST['ingresso']) ? $_POST['ingresso'] : '' ?>"><option value="">Tutti</option><option value="3831">Citofono 3831</option><option value="3832">Citofono 3832</option><option value="3833">Citofono 3833</option></select></TD>
...
if (isset($_POST["button"])) {
	...
	$sql = 
                "SELECT * FROM cdr_accessi_eur WHERE stato LIKE '%".$tipo."%' && (nome_azienda LIKE '%".$azienda."%' && nome_azienda NOT LIKE '%Pick Center%' && nome_azienda NOT LIKE '%B%Side%') && src LIKE '%".$ingresso."%' && codice_pin LIKE '%".$codice."%' && (data_ingresso BETWEEN '".$dal."' AND '".$al."') AND src LIKE '383%' ORDER BY data_ingresso DESC, ora_ingresso DESC ";
	...
	$num_righe = $result->num_rows;
		...
		echo "<P align=center><a href=\"#\" onclick=\"$('#customers').tableExport({type:'excel',escape:'false'});\"><img src='images/export_xls.png' width=48 title='ESPORTA IN EXCEL' align='center'></a><a href=\"#\" onclick=\"stampa()\"><img src='images/export_print.png' width=48 title='STAMPA' align='center' hspace=\"10\"></a>"
...
<?php if (isset($_POST["button"])) { echo "<BR><P align='center'><a href=\"#\" onclick=\"$('#customers').tableExport({type:'excel',escape:'false'});\"><img src='images/export_xls.png' width=64 title='ESPORTA IN EXCEL'></a><a href=\"#\" onclick=\"stampa()\"><img src='images/export_print.png' width=64 title='STAMPA' hspace=\"10\"></a></p>"; } ?>
