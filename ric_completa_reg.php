...
body {
  ...
  background-image: url(images/sfondo_regolo.jpg);
...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="hit-the-floor">Visualizzazione accessi - REGOLO</div></h3><BR>
                ...
                <TR style="font-family:Georgia, Garamond, Serif;font-size:small;">
                        ...
                        <TD><select name="ingresso" id="ingresso" style="color:black" value="<?php echo isset($_POST['ingresso']) ? $_POST['ingresso'] : '' ?>"><option value="">Tutti</option><option value="3331">Portone piano terra</option><option value="3332">Portone primo piano</option><option value="3333">Portone secondo piano</option><option value="3334">Primo piano lato Gracchi (bar)</option><option value="3335">Secondo piano lato Gracchi</option></select></TD>
...
if (isset($_POST["button"])) {
	...
	$sql = 
                "SELECT * FROM cdr_accessi_regolo WHERE stato LIKE '%".$tipo."%' && (nome_azienda LIKE '%".$azienda."%' && nome_azienda NOT LIKE '%Pick Center%' && nome_azienda NOT LIKE '%B%Side%') && src LIKE '%".$ingresso."%' && codice_pin LIKE '%".$codice."%' && (data_ingresso BETWEEN '".$dal."' AND '".$al."') AND src IN('3331','3332','3333','3334','3335') ORDER BY data_ingresso DESC, ora_ingresso DESC ";
