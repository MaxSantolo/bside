...
if (isset($_POST["button"])) {
	...
	$al = $al ?: '9999-12-31 23:59';
        ...
        $intcit = "IN('3531','3532','3533','3535','3831','3832','3833','3834','3331','3332','3333','3334','3335')";
         ...
         $sql = 
                  "SELECT * FROM cdr_accessi_sum WHERE (nome_azienda LIKE '%".$azienda."%' and nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') && pin LIKE '%".$codice."%' && (data_ingresso BETWEEN '".$dal."' AND '".$al."') && auth LIKE '95' AND src ".$intcit." "
                . "     UNION ALL "
                . "SELECT * FROM cdr_accessi_eur_sum WHERE (nome_azienda LIKE '%".$azienda."%' and nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') && pin LIKE '%".$codice."%' && (data_ingresso BETWEEN '".$dal."' AND '".$al."') && auth LIKE '95' AND src ".$intcit." "
                . "     UNION ALL "
                . "SELECT * FROM cdr_accessi_regolo_sum WHERE (nome_azienda LIKE '%".$azienda."%' and nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') && pin LIKE '%".$codice."%' && (data_ingresso BETWEEN '".$dal."' AND '".$al."') && auth LIKE '95' AND src ".$intcit." "

                 . " GROUP BY  data_ingresso ORDER BY pin ASC, data_ingresso ASC, nome_azienda ASC ";
        
        
} else { $sql = 
                  "SELECT * FROM cdr_accessi_sum WHERE (nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') AND (data_ingresso BETWEEN '".date("Y-m-d", strtotime("first day of this month"))."' AND '".date("Y-m-d", strtotime("last day of this month"))."') && auth LIKE '95'"
                . "     UNION ALL "
                . "SELECT * FROM cdr_accessi_eur_sum WHERE (nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') AND (data_ingresso BETWEEN '".date("Y-m-d", strtotime("first day of this month"))."' AND '".date("Y-m-d", strtotime("last day of this month"))."') && auth LIKE '95'"
                . "     UNION ALL "
                . "SELECT * FROM cdr_accessi_regolo_sum WHERE (nome_azienda NOT LIKE '%fornit%' AND nome_azienda NOT LIKE '%MNTN%' AND nome_azienda LIKE 'SmartWorkingHub%') AND (data_ingresso BETWEEN '".date("Y-m-d", strtotime("first day of this month"))."' AND '".date("Y-m-d", strtotime("last day of this month"))."') && auth LIKE '95'"
